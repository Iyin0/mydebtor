            ...
            <div className="add-new-debtor-page">
                ...
                <div className="add-new-debtor">
                    <div className="add-details-header">
                        <h1>Add a new debtor</h1>
                    </div>
                    <form action="" className="add-details-form">
                        <label htmlFor="" className="add-details-label">Full name</label><br />
                        <div className="add-input-container">
                            <input type="text" className="add-details-input" value={name} onChange={(e) => setName(e.target.value)} />
                        </div>
                        <label htmlFor="" className="add-details-label">Amount owed</label><br />
                        <div className="add-input-container">
                            ...
                            <input type="text" className="add-details-input" value={amount} onChange={(e) => setAmount(e.target.value)} />
                        </div>
                        <label htmlFor="" className="add-details-label">Email address</label><br />
                        <div className="add-input-container">
                            <input type="text" className="add-details-input" value={email} onChange={(e) => setEmail(e.target.value)} />
                        </div>
                        <label htmlFor="" className="add-details-label">Gender</label><br />
                        <div className="add-input-container">
                            <input type="text" className="add-details-input" value={gender} onChange={(e) => setGender(e.target.value)} />
                        </div>
                        <label htmlFor="" className="add-details-label">Parent/Guardian's name</label><br />
                        <div className="add-input-container">
                            <input type="text" className="add-details-input" value={parent} onChange={(e) => setParent(e.target.value)} />
                        </div>
                        <label htmlFor="" className="add-details-label">Phone number</label><br />
                        <div className="add-input-container">
                            <input type="text" className="add-details-input" value={phone} onChange={(e) => setPhone(e.target.value)} />
                        </div>
                        <label htmlFor="" className="add-details-label">Debt description</label><br />
                        <div className="add-desc-container">
                            <textarea value={desc} onChange={(e) => setDesc(e.target.value)}></textarea>
                        </div>
                        <button className="add-submit" onClick={(e) => { e.preventDefault() }}>Add new debtor</button>
                    </form>
                </div>
            </div>
        </div>
