                ...
                <div className="debtor-details">
                    ...
                    <div className="debtor-container">
                        <div className="detail">
                            ...
                            <p id="name">{debt.name}</p>
                        </div>
                        <div className="detail">
                            <h3>Email Address:</h3><br />
                            <p id="email">{debt.email}</p>
                        </div>
                        <div className="detail">
                            <h3>Phone number:</h3><br />
                            <p id="number">{debt.number}</p>
                        </div>
                        <div className="detail">
                            <h3>Student name:</h3><br />
                            <p id="ward">{debt.ward}</p>
                        </div>
                        <div className="detail last">
                            <h3>Gender:</h3><br />
                            <p id="gender">{debt.gender}</p>
                        </div>
                    </div>
                </div>
                <div className="debtor-details">
                    ...
                    <div className="debtor-container">
                        <div className="owed">
                            <div className="amount-owed">
                                ...
                                <p id="amount">{debt.amount}</p>
                            </div>
                            <div className="debt-description">
                                <h4>Debt description:</h4>
                                <p id="description">{debt.description}</p>
                            </div>
                        </div>
                    </div>
                </div>
