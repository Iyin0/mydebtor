...
const ContendDebt = () => {
    ...
    const [contend, setContend] = useState(false);
                ...
                <div className="debtor-details">
                    ...
                    <div className="debtor-container">
                        <div className="detail">
                            <h3>Parent/Guardian's name:</h3><br />
                            <p id="name">{debtor.name}</p>
                        </div>
                        <div className="detail">
                            <h3>Email Address:</h3><br />
                            <p id="email">{debtor.email}</p>
                        </div>
                        <div className="detail">
                            <h3>Phone number:</h3><br />
                            <p id="number">{debtor.number}</p>
                        </div>
                        <div className="detail">
                            <h3>Student name:</h3><br />
                            <p id="ward">{debtor.ward}</p>
                        </div>
                        <div className="detail last">
                            <h3>Gender:</h3><br />
                            <p id="gender">{debtor.gender}</p>
                        </div>
                    </div>
                </div>
                <div className="debtor-details">
                    ...
                    <div className="debtor-container">
                        <div className="owed">
                            <div className="amount-owed">
                                ...
                                <p id="amount">{debtor.owes}</p>
                            </div>
                            <div className="debt-description">
                                <h4>Debt description:</h4>
                                <p id="description">{debtor.description}</p>
                            </div>
                        </div>
                    </div>
                </div>
                <button className="to-contend" onClick={() => setContend(true)}>Contend debt</button>
                ...
                {contend ? (
                    <div className="cover">
                        <div className="popup">
                            ...
                            <div className="blank">
                                <div className="msg">
                                    <h3 className="contend-debt-status">Contend Debt</h3>
                                    <p className="contend-debt-para">Are you sure you want to contend?</p>
                                    <div className="contend-debt-btn-container">
                                        <button className="cancel-btn" onClick={() => setContend(false)}>Cancel</button>
                                        <button className="contend-btn" onClick={() => { setContend(false); navigate('/contend-upload') }}>Yes, contend</button>
                                    </div>
                                </div>
                            </div>
                        </div>
